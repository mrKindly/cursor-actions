...
import { Rocket, Shield, Zap, Cpu, MousePointer2, ChevronRight } from 'lucide-react'
    ...
    <main className="animate-fade-in">
      <section className="hero">
        <div className="badge-new">
          ...
          <span className="badge-text">Version 2.0 is now live</span>
      ...
      <section className="features-summary">
